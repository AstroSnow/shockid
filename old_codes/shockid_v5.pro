...
shocktol=0.02 ;tolerence for the shock transitions
...
;    if (x(col(i)) LT xmaxf) and (x(col(i)) GT xminf) and (y(row(i)) LT xmaxf) and (y(row(i)) GT yminf) then begin
;            row2=[row2,row(i)]
;            col2=[col2,col(i)]
;    endif
;endfor
