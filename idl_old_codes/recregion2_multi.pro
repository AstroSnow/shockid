...
tread=[0,66,67,68,69,70,71,72,73,74]
...
i=image(ds.j_z,ds.x,ds.y,xr=[0.7,1.0],yr=[0.2,0.5],axis_sty=2,dim=[970,600],xtitle='x', ytitle='y',layout=[3,3,ti],/current,margin=[0,0,0,0],/buffer)
